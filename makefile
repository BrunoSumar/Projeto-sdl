...
emcc: $(src) $(libs)
	...
	@source $(path_emcc)emsdk/emsdk_env.sh &&	emcc $(emcc_src) $(imgui_src) --preload-file shaders --preload-file resources -s FULL_ES3=1 -s USE_SDL=2 --use-preload-plugins -s USE_SDL_IMAGE=2 -s USE_WEBGL2=1 -s WASM=1 -O3 -o docs/$(output).html -I$(path_emcc) $(emcc_flags)
